 ...
 * @Version: jdk1.8
 */
public class SideOutAllowLateParaDurationDemo {
    public static void main(String[] args) throws Exception {
        ...
        OutputTag<WaterSensor> lateest = new OutputTag<>("lateest", Types.POJO(WaterSensor.class));
        ...
        process.getSideOutput(lateest).printToErr();
        env.execute();
    }
}
